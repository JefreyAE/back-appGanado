...
// Route::delete('/api/injectables/injectable/delete', 'InjectableController@delete')->middleware(ApiAuthMiddleware::class);
...
// Route::put('/api/sales/update','SaleController@update')->middleware(ApiAuthMiddleware::class);
...
// Route::put('/api/purchases/update','PurchaseController@update')->middleware(ApiAuthMiddleware::class);
